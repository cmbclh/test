...
class MarketMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        d['askPrice5'] = {'chinese': vtText.COUNTERPARTYNAME, 'cellType': BasicCell}
...
class TradingWidget(QtWidgets.QFrame):
    ...
    counterPartyNameList = [COUNTERPARTY_GOLDSACHS,
                            COUNTERPARTY_UBS_ZUR]
    ...
    def initUi(self):
        ...
        labelCounterParty = QtWidgets.QLabel(vtText.COUNTERPARTY)
        ...
        self.comboCounterParty = QtWidgets.QComboBox()
        self.comboCounterParty.addItems(self.counterPartyNameList)
        ...
        gridleft.addWidget(labelCounterParty, 11, 0)
        ...
        gridleft.addWidget(self.comboCounterParty, 11, 1, 1, -1)
        ...
        buttonSendOrder.setMinimumHeight(size.height())  # 把按钮高度设为默认
    ...
    def sendOrder(self):
        ...
        req.currency = currency
        req.productClass = productClass
        req.lastTradeDateOrContractMonth = unicode(self.comboCounterParty.currentText())
